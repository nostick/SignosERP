...
@section('content')
    ...
    @include('administration.company.partials.breadcrum',['line' => 'Agregar nuevo'])
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark"><h4>
                        ...
                        <span class="caption-subject bold">Agregar Compañia</span></h4>
                </div>
                <div class="tools">
                </div>
            </div>
            <div class="portlet-body">
                <form action="{{route('company.store')}}" name="company-save" method="POST" id="company-save">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                        <div class="input-icon">
                            <input class="form-control" type="text" name="iibb" id="iibb">
                    ...
                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                        <div class="input-icon">
                            <input class="form-control" type="text" name="bank_data" id="bank_data">
